...
const page = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
      <h1 className="text-3xl font-bold mb-4 text-pink-600">Waist2Plate Terms & Conditions</h1>
      ...
      <section className="mb-6">
        ...
        <p>
          By using the Waist2Plate Application, you agree to all terms & conditions
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>Accuracy:</strong> Hosts are responsible for alert accuracy. Waist2Plate is not liable for inaccuracies.</li>
      ...
      <section className="mb-6">
        ...
        <p>
          The app is provided “as is.” Waist2Plate disclaims all warranties and is not liable
      ...
      <section className="mb-6">
        ...
        <p>
          You agree to defend and hold harmless Waist2Plate and its affiliates from any claims
      ...
      <section className="mb-6">
        ...
        <p>
          All app content belongs to Waist2Plate. You may not use or reproduce content without
          permission.
        </p>
      </section>
